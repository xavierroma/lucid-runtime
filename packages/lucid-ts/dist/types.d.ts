export type SessionState = "STARTING" | "READY" | "RUNNING" | "PAUSED" | "CANCELING" | "ENDED" | "FAILED";
...
export type InputBinding = HoldInputBinding | PressInputBinding | AxisInputBinding | PointerInputBinding | WheelInputBinding;
...
export declare function isTerminalSessionState(state: SessionState): state is "ENDED" | "FAILED";
